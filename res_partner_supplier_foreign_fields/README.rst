================================
Supplier Purchase Foreign Fields
================================
...
This module extends the functionality of res.partner to allow you to configurate the required foreign fields from partner to purchase order. 
...
1. Go to partner and configure the fields required for that partner.
2. Go to purchase and verify the fields for the partner.
