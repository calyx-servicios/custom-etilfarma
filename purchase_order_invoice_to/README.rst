...
This module extends the functionality of Purchase to support Purchase Order Buyer/Invoice to and allow you to
enumerate PO's by year and Client/Buyer/Invoiced to, in Foreign Purchase Orders.

* In this case we want to avoid the regular Purchase Orders Flow.
...
Search in Applications for Purchase Order Invoice To.
...
* Go to Purchases > Purchase Order > Select Foreign Purchase Order Type
* Assign/Modify the Invoice To Client
