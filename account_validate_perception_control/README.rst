===================================
Account Validate Perception Control
===================================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! Modifications to the packing list report   !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "account_validate_perception_control"

* Press Install

* Go to Accounting > Sales > Customer Invoice> Customer Invoice and see the changes
