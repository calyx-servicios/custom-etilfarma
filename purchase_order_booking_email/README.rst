...
This module extends the functionality of Purchase to allow the user to send an email with the Booking Information adding a simple button.
...
1. Go to a Purchase Order Booking section
2. Press the Send as Email button and edit the content
