...
This module extends the functionality of modify packing list report and add new fields in product form
...
1. Go to Inventory / Main data / Asseproduct variantsts /[B1000] PharSQ® Base DS 47/ Inventory and see the changes
